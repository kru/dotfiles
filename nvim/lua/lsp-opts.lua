...
vim.lsp.config.clangd = {
	cmd = { "/home/krisrp/.local/share/nvim/mason/bin/clangd", "--background-index" },
	filetypes = { "c", "h" },
}

vim.lsp.config.luals = {
	cmd = { "/home/krisrp/.local/share/nvim/mason/bin/lua-language-server" },
	filetypes = { "lua" },
	settings = {
		Lua = {
...
vim.lsp.config.ols = {
	cmd = { "/home/krisrp/.local/share/nvim/mason/bin/ols" },
...
vim.lsp.config.gopls = {
	cmd = { "/home/krisrp/.local/share/nvim/mason/bin/gopls" },
	filetypes = { "go" },
	settings = {
