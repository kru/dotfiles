...
syntax match odinDirective /\v#force_inline/
syntax match odinDirective /\v#force_no_inline/
syntax match odinTag /\v#\s*<\w+>/
syntax match odinTag /\v#[+]\s*[[:alpha:]-][[:alnum:]-]*/
...
syntax match odinFunctionDecl "\v<\w+>(\s*::\s*(#\w+\s+)?proc)@="
...
syntax match odinMacro "#force_inline" display  " Optional, for specificity
syntax match odinMacro "#force_no_inline" display
...
highlight link odinTag PreProc
