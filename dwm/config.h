...
/* matches dwm's mouse event processing to your monitor's refresh rate for
 * smoother window interactions */
static const unsigned int refresh_rate = 60;
/* toggles noborder feature (0=disabled, 1=enabled) */
...
/* 0: sloppy systray follows selected monitor, >0: pin systray to monitorX */
